...
<ol>
  ...
  <li><b>엑셀 날짜 서식은 구현했다.</b> 지난 보고서가 '후순위'로 미뤄 둔 마지막
      ...
      규칙도 걸린다.</li>
  <li><b>두 판의 본문 차이는 절반만 없앴다 — 전환 계획에 남은 둘을 적는다.</b>
      HWPX 문단 추출 · 엑셀 날짜 서식 · xls 정수 표기는 파이썬 판에 포팅해
      <b>낱말이 완전히 같아졌다</b>(hwpx·xls·doc·ppt 자카드 1.000). 그러나
      <b>PPTX 발표자 노트(3장 ①)와 XLSX 셀 메모(3장 ②)는 여전히 Rust 판에만 있다</b> —
      실측 자카드 pptx 0.964 · xlsx 0.975 이고, 노트가 많은 문서 한 건은 0.250,
      메모가 본문인 신청서 한 건은 0.490 까지 벌어진다. 같은 문서를 두 판으로 나눠
      돌리는 구간이 있다면 이 두 포맷은 등급이 갈릴 수 있다.</li>
