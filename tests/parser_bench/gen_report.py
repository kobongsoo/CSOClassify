...
<ol>
  ...
  <li><b>엑셀 날짜 서식은 구현했다.</b> 지난 보고서가 '후순위'로 미뤄 둔 마지막
      ...
      규칙도 걸린다.</li>
  <li><b>두 판의 본문 차이는 없앴다.</b> 한동안 HWPX 문단 추출과 엑셀 날짜 서식이
      Rust 판에만 있어 같은 문서가 판마다 다른 본문을 냈다. 둘 다 파이썬 판에 포팅해
      표본에서 두 판의 낱말이 완전히 같아졌다(hwpx 10건·xls 15건 자카드 1.000).
      전환 기간에 두 판을 섞어 써도 등급이 갈리지 않는다.</li>
