...
<ol>
  ...
  <li><b>두 판의 본문 차이는 사실상 없앴다.</b> Rust 판에만 있던 다섯 가지 —
      ...
      <br>※ 남은 0.0006 을 열어 보니 <b>한쪽은 Rust 판이 틀린 것</b>이었다 — 같은
      텍스트상자 구조에서 Rust 의 docx 문단 정규식이 짝을 잘못 맞춰
      <code>"1) 개선사항 Summary"</code> 라는 <b>실제 본문 한 줄을 통째로 놓친다</b>.
      HWPX 에서 한 번 겪은 그 함정(3장 ④)이 docx 에 남아 있다. 별건으로 적어 둔다.</li>
