...
# 용언 활용형의 꼬리. 사전형('~다')만 막았더니 실코퍼스에서 '클릭하면'·'선택하고'·
# '가능하며'·'통하여'·'포함되어야' 가 후보 상위를 차지했다(2026-09-16 첫 실측).
# 이건 빈도 문제가 아니라 문법 문제다 — 어느 회사 문서에서든 문서 종류를 가리키는
# 말이 아니므로, 코퍼스를 보지 않고 모양만으로 버린다.
#
