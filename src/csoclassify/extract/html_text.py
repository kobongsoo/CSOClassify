...
class _Collector(HTMLParser):
    ...
    #------------------------------------------------------------------
    # 자기닫힘 태그(<br/>) — 경계 하나로만 센다
    #=> HTMLParser 는 기본으로 <br/> 을 시작태그+끝태그 두 번으로 나눠 부른다.
    #   그대로 두면 같은 뜻인 <br> 은 개행 1개, <br/> 은 개행 2개가 되어
    #   **같은 파이썬 판 안에서도** 결과가 달라진다(2026-09-11 실측). 자기닫힘
    #   태그는 여는 곳과 닫는 곳이 같은 자리라 경계는 하나뿐이다.
    #   Rust 판은 정규식이 태그 하나를 한 번만 바꾸므로 원래 개행 1개였다 —
    #   두 판의 본문이 갈리던 자리이기도 하다.
    #
    # -in: tag=태그명, attrs=(무시)
    #
    # -out: 없음
